...
if (args.Length == 1 && args[0] == "--test-creature-intents")
{
...
if (args.Length == 1 && args[0] == "--test-ancient-card-priorities")
{
    AncientCardPriorityTests.Run();
    return;
}
